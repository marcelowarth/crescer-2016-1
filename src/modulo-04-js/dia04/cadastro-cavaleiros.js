...
$(function() {
  ...
  $frmNovoCavaleiro.submit(function(e) {
    ...
    var tipoSangue = $('#slTipoSanguineo').val();
    var dataNasc = $('#txtDtNascimento').val();
    var altura = $('#txtAltura').val();
    var peso = $('#txtPeso').val();
    var signo = $('#slSigno').val();
    var locNasc = $('#txtLocalNasc').val();
    var locTrein = $('#txtLocalTrein').val();
    ...
    goldSaints.push({
      ...
      localNascimento: locNasc,
      localTreinamento: locTrein,
      signo: signo,
  ...
  $('button[name=btnAddGolpe]').click(function() {
    $('#golpe').append($('<label>').text('Golpe: ').attr('for', 'golpe'));
    $('#golpe').append($('<input>').attr('id', 'golpe').attr('type', 'text').attr('placeholder', 'Ex: Cólera do dragão').addClass('cadGolpe'));
  });

  $('button[name=btnAddImagem]').click(function() {
    $('#imgs').append($('<label>').text('Imagem: ').attr('for', 'imagem'));
    $('#imgs').append($('<input>').attr('id', 'imagem').attr('type', 'text').attr('placeholder', 'Ex: bit.ly/shiryu.png').addClass('cadUrl'));
    $('#imgs').append($('<label>').text('É Thumbnail: ').attr('for', 'imagemThumb'));
    $('#imgs').append($('<input>').attr('value', 'imagemThumb').attr('type', 'checkbox').attr('name', 'imagemThumb'));
  });
});
